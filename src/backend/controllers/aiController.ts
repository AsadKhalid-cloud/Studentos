...
function generateSmartLocalResponse(prompt: string, contextText: string): string {
...
export async function generateAiResponse(req: Request, res: Response): Promise<void> {
  try {
