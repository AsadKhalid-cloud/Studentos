...
export async function register(req: Request, res: Response): Promise<void> {
  try {
    ...
    // Generate Token
    const payload: TokenPayload = { userId: newUser.id, username: newUser.username, email: newUser.email };
...
export async function login(req: Request, res: Response): Promise<void> {
  try {
    ...
    // Generate Token
    const payload: TokenPayload = { userId: user.id, username: user.username, email: user.email };
    const token = generateToken(payload);
