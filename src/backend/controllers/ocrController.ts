...
const pdfParse = typeof pdfParseDefault === 'function' ? pdfParseDefault : ((pdfParseDefault as any)?.default || pdfParseDefault);

export async function processOcrExtraction(req: Request, res: Response): Promise<void> {
  try {
