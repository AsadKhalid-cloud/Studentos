...
export async function getBackupStats(req, res) {
    try {
...
export async function exportBackup(req, res) {
    try {
        ...
        const [user, universityProfile, semesters, courses, notes, questionBank, codeSnippets, budgetCategories, transactions, tasks, calendarEvents] = await Promise.all([
